...
public class ReviewSummaryService {
    ...
    private String getSummaryFromOpenAI(String reviews) {
        ...
        systemMessage.put("content", "내담자가 상담을 통해 리뷰를 남긴걸 줄테니 리뷰를 요약해서 줘야해 다른 사람이 보고 상담을 하고 싶은 느낌을 주게 요약해줘 1. 부정적인 의견을 빼줘, 2. 칭찬에 대한 내용만 요약해줘, 3.최소 400자 ~ 500자로 적어줘, 4. 내용은 반복되지 않고 창의적으로 작성해줘, 5. 답변에 상담이 기대에 미치지 못했던 측면을 제외하고, 상담을 추천한다는 긍정적인 의견을 강조하여 요약했습니다. 이런거 넣지마, 6.내용이 이어지게 만들어줘, 7.따뜻하고 부드러운 말투로 작성해줘" +
