...
VALUES ('CLIENT', 'mimi@nate.com', '1234', '최미정', '0101112222', 'client1.jpg', '1990-01-01', 'WOMAN', NOW(), NOW()),
       ...
       ('EXPERT', 'expert10@nate.com', '1234', '이유리', '0104442222', 'expert10.jpg', '1994-08-08', 'WOMAN', NOW(),
        NOW());

-- voucher_tb
INSERT INTO voucher_tb (issued_by, owned_by, reservation_id, voucher_type, price, count, duration, discount, start_date,
