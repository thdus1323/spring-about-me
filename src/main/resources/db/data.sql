...
VALUES ('CLIENT', 'mimi@nate.com', '1234', '최미정', '0101112222', 'client01.jpg', '1990-01-01', 'WOMAN', NOW(), NOW()),
       ('CLIENT', 'hae@nate.com', '1234', '장현재', '0101112222', 'client02.jpg', '1992-02-02', 'MAN', NOW(), NOW()),
       ('CLIENT', 'sae@nate.com', '1234', '이사이', '0101112222', 'client03.jpg', '1994-03-03', 'OTHER', NOW(), NOW()),
       ('CLIENT', 'jin@nate.com', '1234', '김진호', '0101112222', 'client041.jpg', '1996-04-04', 'WOMAN', NOW(), NOW()),
       ('CLIENT', 'ji@nate.com', '1234', '서지호', '0101112222', 'client05.png', '1998-05-05', 'MAN', NOW(), NOW()),
       ('CLIENT', 'suji@nate.com', '1234', '박수지', '0101113333', 'client06.jpg', '1990-06-01', 'WOMAN', NOW(), NOW()),
       ('CLIENT', 'jong@nate.com', '1234', '김종현', '0101114444', 'client07.jpg', '1991-07-01', 'MAN', NOW(), NOW()),
       ('CLIENT', 'yuna@nate.com', '1234', '윤아름', '0101115555', 'client08.png', '1992-08-01', 'WOMAN', NOW(), NOW()),
       ('CLIENT', 'minho@nate.com', '1234', '최민호', '0101116666', 'client09.jpg', '1993-09-01', 'MAN', NOW(), NOW()),
       ...
       ('CLIENT', 'woojin@nate.com', '1234', '이우진', '0102224444', 'client171.jpg', '2001-05-01', 'MAN', NOW(), NOW()),
...
VALUES
    ...
    ('TEXT_THERAPY', 21, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
    ('VOICE_THERAPY', 21, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
    ('VIDEO_THERAPY', 21, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),

    -- Expert 2 has 2 voucher types
    ('TEXT_THERAPY', 22, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
    ('VOICE_THERAPY', 22, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),

    -- Expert 3 has 1 voucher type
    ('VIDEO_THERAPY', 23, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),

    -- Expert 4 has 2 voucher types
    ('TEXT_THERAPY', 24, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
    ('VIDEO_THERAPY', 24, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),

    -- Expert 5 has 3 voucher types
    ('TEXT_THERAPY', 25, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
    ('VOICE_THERAPY', 25, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
    ('VIDEO_THERAPY', 25, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),

    -- Expert 6 has 1 voucher type
    ('TEXT_THERAPY', 26, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),

    -- Expert 7 has 2 voucher types
    ('VOICE_THERAPY', 27, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
    ('VIDEO_THERAPY', 27, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),

    -- Expert 8 has 3 voucher types
    ('TEXT_THERAPY', 28, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
    ('VOICE_THERAPY', 28, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
    ('VIDEO_THERAPY', 28, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),

    -- Expert 9 has 2 voucher types
    ('TEXT_THERAPY', 29, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
    ('VOICE_THERAPY', 29, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),

    -- Expert 10 has 1 voucher type
    ('VIDEO_THERAPY', 30, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW());

-- voucher_tb
INSERT INTO voucher_tb (voucher_type, expert_id, price, count, duration, image_path, start_date, created_at, updated_at)
VALUES ('TEXT_THERAPY', 21, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 21, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 21, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 22, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 22, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 22, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 23, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 23, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 23, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 24, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 24, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 24, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 25, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 25, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 25, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 26, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 26, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 26, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 27, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 27, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 27, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 28, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 28, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ...
       ('TEXT_THERAPY', 29, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 29, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 29, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 30, 10000, 1, 60, 'chat.png', NOW(), NOW(), NOW()),
       ('VOICE_THERAPY', 30, 15000, 1, 30, 'call.png', NOW(), NOW(), NOW()),
       ('VIDEO_THERAPY', 30, 20000, 1, 45, 'video.png', NOW(), NOW(), NOW());
-- voucher_history_tb
...
VALUES
    -- Expert 1
    (21, 1, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (21, 2, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (21, 3, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 2
    (22, 4, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (22, 5, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (22, 6, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 3
    (23, 7, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (23, 8, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (23, 9, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 4
    (24, 10, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (24, 11, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (24, 12, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 5
    (25, 13, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (25, 14, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (25, 15, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 6
    (26, 16, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (26, 17, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (26, 18, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 7
    (27, 19, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (27, 20, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (27, 1, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 8
    (28, 2, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (28, 3, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (28, 4, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 9
    (29, 5, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (29, 6, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (29, 7, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW()),
    -- Expert 10
    (30, 8, NULL, 'TEXT_THERAPY', 10000, 1, 60, 0.1, NOW(), NULL, TRUE, 'chat.png', NOW(), NOW()),
    (30, 9, NULL, 'VOICE_THERAPY', 15000, 1, 30, 0.2, NOW(), NULL, TRUE, 'call.png', NOW(), NOW()),
    (30, 10, NULL, 'VIDEO_THERAPY', 20000, 1, 45, 0.15, NOW(), NULL, TRUE, 'video.png', NOW(), NOW());
