...
VALUES
    ('TEXT_THERAPY', 21, 10000, 1, 60, '/images/chat.png', NOW(), NOW(), NOW()),
       ...
       ('VOICE_THERAPY', 21, 20000, 1, 45, '/images/video.png', NOW(), NOW(), NOW()),
       ('TEXT_THERAPY', 22, 10000, 1, 60, '/images/chat.png', NOW(), NOW(), NOW()),
...
VALUES (12, 21, 1, '상담을 통해 문제의 원인을 분석했습니다.', NOW(), NOW(), NOW()),
...
VALUES (12, 1, '상담사와의 대화가 많은 도움이 되었고, 문제의 원인을 알 수 있었습니다.나나나나나', NOW(), NOW()),
